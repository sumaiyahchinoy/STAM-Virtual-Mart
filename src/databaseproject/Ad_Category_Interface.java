 ...
 * @author Void
 */
public class Ad_Category_Interface extends javax.swing.JFrame {

    //Boolean isVisible = true;
    
    
    public Ad_Category_Interface() {
        initComponents();
   
    }
    public Ad_Category_Interface(int a) {
        initComponents();
        AID =a;
    }
    int AID;
    ...
    private void initComponents() {
        ...
        BackgroundPanel.add(transaction, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 580, 110, -1));
        ...
        addModel.setBackground(new java.awt.Color(255, 255, 255));
        addModel.setFont(new java.awt.Font("Nirmala UI", 1, 36)); // NOI18N
        addModel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/Add_Model(250).png"))); // NOI18N
        addModel.setText("<html>\nADD MODEL\n</html>");
        addModel.setBorderPainted(false);
        addModel.setContentAreaFilled(false);
        addModel.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        addModel.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        addModel.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                addModelActionPerformed(evt);
            }
        });
        BackgroundPanel.add(addModel, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 230, -1, -1));

        addBrand.setBackground(new java.awt.Color(255, 255, 255));
        addBrand.setFont(new java.awt.Font("Nirmala UI", 1, 36)); // NOI18N
        addBrand.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/Add_Brand(250).png"))); // NOI18N
        addBrand.setText("<html>\nADD BRAND\n</html>");
        addBrand.setBorderPainted(false);
        addBrand.setContentAreaFilled(false);
        addBrand.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        addBrand.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        addBrand.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                addBrandActionPerformed(evt);
            }
        });
        BackgroundPanel.add(addBrand, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 230, -1, -1));
    ...
    private void addModelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addModelActionPerformed
        // TODO add your handling code here:
        new Add_Category(AID).setVisible(true);
        this.setVisible(false);
    ...
    private void addBrandActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addBrandActionPerformed
        // TODO add your handling code here:
        new Add_Subcategory(AID).setVisible(true);
        this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ad_Category_Interface.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            }
//        });
        JFrame newMain = new Ad_Category_Interface();
