...
public class AddProduct extends javax.swing.JFrame {
    ...
    public void AddProductDetails() {
        ...
        String pd = description.getText();
    System.out.println(Path);
        try {

            String Str_Query = "INSERT INTO ITEM_DETAIL (ITEM_NAME, COST_PRICE, SELLING_PRICE, SELLER_ID,TOTAL_QUANTITY, CURRENT_INVENTORY, APPROVAL_STATUS, DESCRIPTION, ITEM_IMAGE)"
                    + " VALUES (?,?,?,?,?,?,?,?,?)";
            ...
            ps.setInt(2, pprice);
            ps.setInt(3, pprice);
            ps.setInt(4, this.SID);
            ps.setInt(5, pquantity);
            ps.setInt(6, pquantity);
    ...
    private void initComponents() {
        ...
        quantity.setFont(new java.awt.Font("Nirmala UI", 0, 18)); // NOI18N
