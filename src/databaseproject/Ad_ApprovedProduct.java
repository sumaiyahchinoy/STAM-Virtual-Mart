 ...
 * @author Void
 */
public class Ad_ApprovedProduct extends javax.swing.JFrame {
    ...
    public Ad_ApprovedProduct(int a) {
        initComponents();
        AID = a;
        mycon = db_connection.getConnection();
        jTable1.getTableHeader().setFont(new Font("Nirmula UI", Font.BOLD, 14));
    ...
    public void UpdateTable() {
        ...
        try {
            String Str_Query = "Select ITEM_ID, ITEM_NAME, SELLING_PRICE, CURRENT_INVENTORY, TOTAL_QUANTITY, ADMIN_ID from ITEM_DETAIL where APPROVAL_STATUS ='APPROVED'";
            ...
            while (resultSet.next()) {
                ...
                String Admin_Id = String.valueOf(resultSet.getInt("ADMIN_ID"));
                String row[] = {Item_Id, Item_Name, Selling_Price, Current_Inventory, Total_Quantity, Admin_Id};
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/approveitems(80).png"))); // NOI18N
        jLabel2.setText("APPROVED PRODUCTS");
        BackgroundPanel.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 160, -1, -1));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "Price", "Current Quantity", "Total Quantity", "Admin ID"
            }
        ) {
        ...
        BackgroundPanel.add(showProductDetail, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 600, 390, 70));
    ...
    private void showProductDetailActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_showProductDetailActionPerformed
        ...
        if (jTable1.getSelectionModel().isSelectionEmpty()) {
            ...
            this.setVisible(false);
            new Ad_ApprovedProduct_ProductPopUp(Integer.parseInt(selectedCellValue),AID).setVisible(true);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ad_ApprovedProduct.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            }
//        });
        JFrame newMain = new Ad_ApprovedProduct();
