...
public class CustomerForgotPassword extends javax.swing.JFrame {
    ...
    private void Forgot_Method() {
        ...
        String s = Q + sa;
        try {
            String Str_Query = "Select CUSTOMER_ID from Customer where Email=? and Security_Question=?";
            PreparedStatement ps = myConn.prepareStatement(Str_Query);
            ps.setString(1, em);
            ps.setString(2, s);
    ...
    private void getQuestion(){
      ...
      try {
            String Str_Query1 = "Select Security_Question from CUSTOMER where Customer_ID=?";
            PreparedStatement ps1 = myConn.prepareStatement(Str_Query1);
            ps1.setString(1, CID.toString());
            ...
            ResultSet resultSet1 = ps1.executeQuery();
             ...
             while (resultSet1.next()) {
                qa = resultSet1.getString("Security_Question");
            }
            
            String separator ="?";
            int sepPos = qa.lastIndexOf(separator);
            Q = qa.substring(0,sepPos + 1);
    ...
    private void initComponents() {
        ...
        Reset.setFont(new java.awt.Font("Nirmala UI", 1, 30)); // NOI18N
        ...
        BackgroundPanel.add(Reset, new org.netbeans.lib.awtextra.AbsoluteConstraints(910, 610, 270, 70));
        ...
        SQ.setFont(new java.awt.Font("Nirmala UI", 0, 30)); // NOI18N
        SQ.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                SQActionPerformed(evt);
            }
        });
        BackgroundPanel.add(SQ, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 490, 510, 50));
    ...
    private void ResetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ResetActionPerformed
        ...
        if (SQ.getText().equals("")) {
            JOptionPane.showMessageDialog(f, "Missing Value, Validate your email to get the security question.", "ERROR", JOptionPane.ERROR_MESSAGE); 
            ...
            if (CID == 0) {
                JOptionPane.showMessageDialog(f, "Incorrect answer entered. Please answer the security question again.", "ERROR", JOptionPane.ERROR_MESSAGE);

            } else {
                new CustomerResetPassword(CID).setVisible(true);
    ...
    private void validateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_validateActionPerformed
        ...
        if (email.getText().equals("")) {
            JOptionPane.showMessageDialog(f, "Missing Value, Enter Email to validate.", "ERROR", JOptionPane.ERROR_MESSAGE);

        } else if (CID == 0) {
            JOptionPane.showMessageDialog(f, "Incorrect Email . Please try again.", "ERROR", JOptionPane.ERROR_MESSAGE);
        }
        else {
                
            JOptionPane.showMessageDialog(null, "Your Email has been successfully validated.");
            getQuestion();
            SQ.setText(Q);
