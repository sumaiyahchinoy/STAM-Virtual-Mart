...
public class SellerForgotPassword extends javax.swing.JFrame {
    ...
    public void email_check() {
        ...
        try {
            String Str_Query = "Select SELLER_ID from SELLER where Email=?";
    ...
    private void Forgot_Method() {
        ...
        String s = Q + sa;
        try {
            String Str_Query = "Select SELLER_ID from SELLER where Email=? and Security_Question=?";
            PreparedStatement ps = myConn.prepareStatement(Str_Query);
            ps.setString(1, em);
            ps.setString(2, s);
    ...
    private void getQuestion(){
      ...
      try {
            String Str_Query1 = "Select Security_Question from SELLER where Seller_ID=?";
            PreparedStatement ps1 = myConn.prepareStatement(Str_Query1);
            ps1.setString(1, SID.toString());
    ...
    private void ResetPasswordActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ResetPasswordActionPerformed
        ...
        if (SQ.getText().equals("")) {
            ...
            if (SID == 0) {
                ...
                new SellerResetPassword(SID).setVisible(true);
