 ...
 * @author Void
 */
public class Ad_Product_Interface extends javax.swing.JFrame {

    //Boolean isVisible = true;
    
    
    public Ad_Product_Interface() {
        initComponents();
   
    }
    int AID;
    public Ad_Product_Interface(int a) {
        initComponents();
        AID =a;
    }
    ...
    private void initComponents() {
        ...
        currentInventory = new javax.swing.JButton();
        ...
        approvedProducts = new javax.swing.JButton();
        UnapprovedProducts = new javax.swing.JButton();
        ...
        currentInventory.setBackground(new java.awt.Color(255, 255, 255));
        currentInventory.setFont(new java.awt.Font("Nirmala UI", 1, 36)); // NOI18N
        currentInventory.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/inventory(100).png"))); // NOI18N
        currentInventory.setText("<html> OUT OF STOCK PRODUCTS </html>");
        currentInventory.setBorderPainted(false);
        currentInventory.setContentAreaFilled(false);
        currentInventory.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        currentInventory.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        currentInventory.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                currentInventoryActionPerformed(evt);
            }
        });
        BackgroundPanel.add(currentInventory, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 460, -1, -1));
        ...
        approvedProducts.setBackground(new java.awt.Color(255, 255, 255));
        approvedProducts.setFont(new java.awt.Font("Nirmala UI", 1, 36)); // NOI18N
        approvedProducts.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/approveitems(100).png"))); // NOI18N
        approvedProducts.setText("<html>\nAPPROVED\n<br>\nPRODUCTS\n</html>");
        approvedProducts.setBorderPainted(false);
        approvedProducts.setContentAreaFilled(false);
        approvedProducts.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        approvedProducts.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        approvedProducts.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                approvedProductsActionPerformed(evt);
            }
        });
        BackgroundPanel.add(approvedProducts, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 190, -1, -1));

        UnapprovedProducts.setBackground(new java.awt.Color(255, 255, 255));
        UnapprovedProducts.setFont(new java.awt.Font("Nirmala UI", 1, 36)); // NOI18N
        UnapprovedProducts.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/unapproveditem(100).png"))); // NOI18N
        UnapprovedProducts.setText("<html>\nUNAPPROVED\n<br>\nPRODUCTS\n</html>");
        UnapprovedProducts.setBorderPainted(false);
        UnapprovedProducts.setContentAreaFilled(false);
        UnapprovedProducts.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        UnapprovedProducts.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        UnapprovedProducts.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                UnapprovedProductsActionPerformed(evt);
            }
        });
        BackgroundPanel.add(UnapprovedProducts, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 190, -1, -1));
    ...
    private void currentInventoryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_currentInventoryActionPerformed
        // TODO add your handling code here:
        new Ad_OutOfInventory(AID).setVisible(true);
        this.setVisible(false);
    }//GEN-LAST:event_currentInventoryActionPerformed

    private void categoryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_categoryActionPerformed
        // TODO add your handling code here:
        new Ad_Category_Interface(AID).setVisible(true);
        this.setVisible(false);
    ...
    private void approvedProductsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_approvedProductsActionPerformed
        // TODO add your handling code here:
        new Ad_ApprovedProduct(AID).setVisible(true);
        this.setVisible(false);
    }//GEN-LAST:event_approvedProductsActionPerformed

    private void UnapprovedProductsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UnapprovedProductsActionPerformed
        // TODO add your handling code here:
        new Ad_UnApprovedProduct(AID).setVisible(true);
        this.setVisible(false);
    }//GEN-LAST:event_UnapprovedProductsActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ad_Product_Interface.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            }
//        });
        JFrame newMain = new Ad_Product_Interface();
    ...
    private javax.swing.JButton UnapprovedProducts;
    private javax.swing.JLabel admin;
    private javax.swing.JLabel admin2;
    private javax.swing.JLabel admin3;
    private javax.swing.JButton approvedProducts;
    private javax.swing.JButton category;
    private javax.swing.JButton currentInventory;
