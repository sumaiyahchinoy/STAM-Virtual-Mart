 ...
 * @author Void
 */
public class Ad_BlockedSeller_ProductPopUp extends javax.swing.JFrame {

    //Boolean isVisible = true;
    String ItemId ;
    public Ad_BlockedSeller_ProductPopUp() {
        initComponents();

    }
    
    public Ad_BlockedSeller_ProductPopUp(int i,int s,int a) {
        initComponents();
    ...
    private void backActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backActionPerformed
        ...
        new Ad_BlockedSeller_Inventory(SID,AID).setVisible(true);
...
//            }
//        });
        JFrame newMain = new Ad_BlockedSeller_ProductPopUp();
