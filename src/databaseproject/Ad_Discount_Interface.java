...
public class Ad_Discount_Interface extends javax.swing.JFrame {
    ...
    int AID ;
    public Ad_Discount_Interface(int a) {
        initComponents();
        AID =a;
    ...
    private void initComponents() {
        ...
        BackgroundPanel.add(applyDiscount, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 270, -1, -1));
        ...
        BackgroundPanel.add(addDiscount, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 270, -1, -1));
    ...
    private void applyDiscountActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_applyDiscountActionPerformed
        // TODO add your handling code here:
        new Apply_Discount(AID).setVisible(true);
        this.setVisible(false);
    ...
    private void addDiscountActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addDiscountActionPerformed
        // TODO add your handling code here:
        new Add_Discount(AID).setVisible(true);
        this.setVisible(false);
