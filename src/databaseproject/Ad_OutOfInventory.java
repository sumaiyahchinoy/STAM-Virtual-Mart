 ...
 * @author Void
 */
public class Ad_OutOfInventory extends javax.swing.JFrame {
    ...
    public Ad_OutOfInventory(int a) {
        initComponents();
        AID = a;
        mycon = db_connection.getConnection();
        jTable1.getTableHeader().setFont(new Font("Nirmula UI", Font.BOLD, 14));
    ...
    public void UpdateTable() {
        ...
        try {
            String Str_Query = "Select ITEM_ID, ITEM_NAME, SELLING_PRICE, CURRENT_INVENTORY, TOTAL_QUANTITY, ADMIN_ID from ITEM_DETAIL where CURRENT_INVENTORY=0 and APPROVAL_STATUS='APPROVED'";
    ...
    private void initComponents() {
        ...
        jLabel2.setText("OUT OF STOCK PRODUCT ");
        ...
        BackgroundPanel.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 250, 1040, 330));
    ...
    private void showProductDetailActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_showProductDetailActionPerformed
        ...
        if (jTable1.getSelectionModel().isSelectionEmpty()) {
            ...
            this.setVisible(false);
            new Ad_Out_of_inventory_ProductPopUp(Integer.parseInt(selectedCellValue), AID).setVisible(true);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ad_OutOfInventory.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            }
//        });
        JFrame newMain = new Ad_OutOfInventory();
