 ...
 * @author Void
 */
public class SellerResetPassword extends javax.swing.JFrame {
    ...
    public SellerResetPassword() {
        initComponents();
        myConn = db_connection.getConnection();
    }
    
    public SellerResetPassword(int sellerId) {
        initComponents();
        myConn = db_connection.getConnection();
        SID = sellerId;    
    }
    ...
    private void initComponents() {
        ...
        BackgroundPanel.add(cpassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 480, 420, 50));
        ...
        npassword.setFont(new java.awt.Font("Nirmala UI", 0, 30)); // NOI18N
        npassword.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        npassword.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                npasswordActionPerformed(evt);
            }
        });
        BackgroundPanel.add(npassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 360, 420, 50));
    ...
    private void UpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdateActionPerformed
        ...
        if (npassword.getText().equals("")) {
            JOptionPane.showMessageDialog(f, "Missing Value, Enter the new Password", "ERROR", JOptionPane.ERROR_MESSAGE);
        } else if (cpassword.getText().equals("")) {
            JOptionPane.showMessageDialog(f, "Missing Value, Re-enter the Password for confirmation", "ERROR", JOptionPane.ERROR_MESSAGE);
        } else if (!npassword.getText().equals(cpassword.getText())) {
            JOptionPane.showMessageDialog(f, "Both Passwords do not match. Enter passwords again.", "ERROR", JOptionPane.ERROR_MESSAGE);
        } else {
        Reset_Method();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SellerResetPassword.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            }
//        });
        JFrame newMain = new SellerResetPassword();
