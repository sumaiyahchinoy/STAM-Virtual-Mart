 ...
 * @author Void
 */
public class Ad_ActiveSeller_ProductPopUp extends javax.swing.JFrame {
    ...
    int SID;
    Connection con;
    public Ad_ActiveSeller_ProductPopUp() {
        initComponents();

    }
    
    public Ad_ActiveSeller_ProductPopUp(int i,int s,int AID) {
        initComponents();
        this.PID = i;
        this.AID =AID;
        SID =s;
    ...
    private void initComponents() {
        ...
        panel.add(name, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 110, 410, 50));
        ...
        panel.add(back, new org.netbeans.lib.awtextra.AbsoluteConstraints(-20, 540, 130, 70));
    ...
    private void backActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backActionPerformed
        ...
        new Ad_ActiveSeller_Inventory(SID,AID).setVisible(true);
...
//            }
//        });
        JFrame newMain = new Ad_ActiveSeller_ProductPopUp();
