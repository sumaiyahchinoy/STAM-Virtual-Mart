 ...
 * @author Void
 */
public class Ad_UnApprovedProduct_ProductPopUp extends javax.swing.JFrame {

    //Boolean isVisible = true;

    public Ad_UnApprovedProduct_ProductPopUp() {
        initComponents();

    }

    public Ad_UnApprovedProduct_ProductPopUp(int i, int a) {
        initComponents();
        PID =i;
        AID =a;
...
//            }
//        });
        JFrame newMain = new Ad_UnApprovedProduct_ProductPopUp();
