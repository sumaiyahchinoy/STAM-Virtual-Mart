 ...
 * @author Void
 */
public class Ad_Customer_Interface extends javax.swing.JFrame {

    //Boolean isVisible = true;
    
    
    public Ad_Customer_Interface() {
        initComponents();
   
    }
    int AID;
     public Ad_Customer_Interface(int a) {
        initComponents();
        AID =a;
    }
    ...
    private void initComponents() {
        ...
        activeCustomer = new javax.swing.JButton();
        blockedCustomer = new javax.swing.JButton();
        ...
        BackgroundPanel.add(sellers, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 270, -1, -1));
        ...
        activeCustomer.setBackground(new java.awt.Color(255, 255, 255));
        activeCustomer.setFont(new java.awt.Font("Nirmala UI", 1, 36)); // NOI18N
        activeCustomer.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/customer(250).png"))); // NOI18N
        activeCustomer.setText("<html>\nACTIVE\n<br>\nCUSTOMERS\n</html>");
        activeCustomer.setBorderPainted(false);
        activeCustomer.setContentAreaFilled(false);
        activeCustomer.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        activeCustomer.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        activeCustomer.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                activeCustomerActionPerformed(evt);
            }
        });
        BackgroundPanel.add(activeCustomer, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 190, -1, -1));

        blockedCustomer.setBackground(new java.awt.Color(255, 255, 255));
        blockedCustomer.setFont(new java.awt.Font("Nirmala UI", 1, 36)); // NOI18N
        blockedCustomer.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/blockedcustomer(250).png"))); // NOI18N
        blockedCustomer.setText("<html>\nBLOCKED\n<br>\n CUSTOMERS\n</html>");
        blockedCustomer.setBorderPainted(false);
        blockedCustomer.setContentAreaFilled(false);
        blockedCustomer.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        blockedCustomer.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        blockedCustomer.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                blockedCustomerActionPerformed(evt);
            }
        });
        BackgroundPanel.add(blockedCustomer, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 200, -1, -1));
    ...
    private void activeCustomerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_activeCustomerActionPerformed
        // TODO add your handling code here:
        new Ad_ActiveCustomer(AID).setVisible(true);
        this.setVisible(false);
    }//GEN-LAST:event_activeCustomerActionPerformed

    private void blockedCustomerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_blockedCustomerActionPerformed
    
        
        
        new Ad_BlockCustomer(AID).setVisible(true);
        this.setVisible(false);
        
        
    }//GEN-LAST:event_blockedCustomerActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ad_Customer_Interface.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            }
//        });
        JFrame newMain = new Ad_Customer_Interface();
    ...
    private javax.swing.JButton activeCustomer;
    private javax.swing.JLabel admin;
    private javax.swing.JLabel admin2;
    private javax.swing.JLabel admin3;
    private javax.swing.JButton blockedCustomer;
